...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeBox = __webpack_require__(229);
	var RecipeForm = __webpack_require__(253);
	var RecipeEditForm = __webpack_require__(254);
	...
	ReactDOM.render(React.createElement(
	                ...
	                React.createElement(_reactRouter.Route, { path: '/add', component: RecipeForm }),
	                React.createElement(_reactRouter.Route, { path: '/add/edit', component: RecipeEditForm })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeForm = __webpack_require__(253);
	var RecipeEditForm = __webpack_require__(254);
	var RecipeStore = __webpack_require__(252);
	...
	var RecipeBox = React.createClass({
			...
			addRecipe: function addRecipe(txtName, arrIngr) {
			...
			render: function render() {
					...
					if (!this.state.edObj.isEdit) {
							return React.createElement(
									...
									React.createElement(RecipeList, { data: this.state.data, handee: this.upper }),
									React.createElement(
											Link,
											{ to: '/add', className: 'active' },
											'Add Recipe'
									)
							);
					} else {
							return React.createElement(
									'div',
									{ className: 'edit_form' },
									React.createElement(RecipeEditForm, { onEdit: this.quitEdit, data: this.state.edObj })
							);
					}
			},
			...
			upper: function upper(ky, nam, ingr) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(4);
	var RecipeItem = __webpack_require__(231);
	...
	var RecipeList = React.createClass({
						...
						render: function render() {
											...
											var list_nodes = this.props.data.map(function (ob) {
																...
																return React.createElement(RecipeItem, { name: ob.name, ingr: ob.ingr, key: ob.id, id: ob.id, handee: handee });
											});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeActions = __webpack_require__(232);
	var RecipeStore = __webpack_require__(252);
							...
							render: function render() {
													...
													return React.createElement(
																			...
																			React.createElement(
																									...
																									React.createElement(
																															'a',
																															{ className: 'btn btn-default btn-primary', onClick: this.buttonHandler },
																															this.props.name
																									)
																			),
																			React.createElement(
																									...
																									React.createElement(
																															'a',
																															{ className: 'btn  btn-sm btn-warning', onClick: this.handleDel },
																															'Delete '
																									)
																			),
																			React.createElement(
																									...
																									React.createElement(
																															'a',
																															{ className: 'btn  btn-sm btn-success', onClick: this.handleEdit },
																															'Edit '
																									)
																			),
																			React.createElement(
																									...
																									React.createElement(
																															'a',
																															{ className: 'btn  btn-sm btn-danger btn-close ', onClick: this.handleClose },
																															'X '
																									)
																			),
																			React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(233);

	var RecipeActions = Reflux.createActions(['createRecipe', 'editRecipe', 'deleteRecipe']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(234);

	Reflux.connect = __webpack_require__(247);

	Reflux.connectFilter = __webpack_require__(249);

	Reflux.ListenerMixin = __webpack_require__(248);

	Reflux.listenTo = __webpack_require__(250);

	Reflux.listenToMany = __webpack_require__(251);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ActionMethods = __webpack_require__(235);

	Reflux.ListenerMethods = __webpack_require__(236);

	Reflux.PublisherMethods = __webpack_require__(245);

	Reflux.StoreMethods = __webpack_require__(244);

	Reflux.createAction = __webpack_require__(246);

	Reflux.createStore = __webpack_require__(240);

	var maker = __webpack_require__(239).staticJoinCreator;
	...
	var _ = Reflux.utils = __webpack_require__(237);
	...
	Reflux.__keep = __webpack_require__(241);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(237),
	    maker = __webpack_require__(239).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(240),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(237),
	    Keep = __webpack_require__(241),
	    mixer = __webpack_require__(242),
	    bindMethods = __webpack_require__(243);
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(244),
	        PublisherMethods = __webpack_require__(245),
	        ListenerMethods = __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(237),
	    ActionMethods = __webpack_require__(235),
	    PublisherMethods = __webpack_require__(245),
	    Keep = __webpack_require__(241);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListenerMethods = __webpack_require__(236),
	    ListenerMixin = __webpack_require__(248),
	    _ = __webpack_require__(237);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeStore = Reflux.createStore({
		...
		onCreate: function onCreate(ID, nm, ing) {
			var num = ID + 1;
			var newObj = {
				id: num,
				name: nm,
		...
		onEdit: function onEdit(key, name, ingr) {
		...
		onDelete: function onDelete(ky) {
			//to be added
			var arr = [];
			arr = _recipes.filter(function (val, i) {
				return val.id !== ky;
			});
			_recipes = arr;
			this.trigger(_recipes);
		...
		getIDofLast: function getIDofLast() {
			return _recipes[_recipes.length - 1].id;
		},
		getNumOfRecipes: function getNumOfRecipes() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeForm = React.createClass({
						...
						render: function render() {
											return React.createElement(
																'form',
																{ onSubmit: this.frmSubmit },
																React.createElement(
																					'label',
																					null,
																					'Recipe Name:'
																),
																React.createElement('input', { type: 'text', ref: 'rcpName' }),
																React.createElement(
																					'label',
																					null,
																					'Ingredients:'
																),
																React.createElement('input', { type: 'text', ref: 'rcpIngr' }),
																React.createElement(
																					'button',
																					{ type: 'submit', onClick: this.btnClick },
																					'Add Submit '
																)
											);
						},
						...
						frmSubmit: function frmSubmit(e) {
						...
						render: function render() {
											return React.createElement(
																...
																React.createElement(
																					...
																					React.createElement('input', { id: 'nam', className: 'form-control', type: 'text', ref: 'rcpName', onChange: this.onChange, defaultValue: this.props.data.nm })
																),
																React.createElement(
																					'div',
																					{ className: 'form-group' },
																					...
																					React.createElement('input', { type: 'text', className: 'form-control', id: 'ing', ref: 'rcpIngr', onChange: this.onChange, defaultValue: this.props.data.ing })
																),
																React.createElement(
																					'button',
																					{ type: 'submit', onClick: this.btnClick },
